        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BranchAdres = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeliveryTimeName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ALTGRUP3 = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GRUPADI = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SssTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SssContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeslimatYontemi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TeslimatSaati = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AlternatifUrun = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    OrderKat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderSehir = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderIlce = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserApartman = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserDaire = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserKat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserSehir = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserIlce = table.Column<string>(type: "nvarchar(max)", nullable: false),
